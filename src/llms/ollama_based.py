...
class ChatOllama(BaseChat):
    ...
    def __call__(self, sys_msg: str, prompt: str) -> Union[str, List[str]]:
        messages = [{'role': 'system', 'content': "You are an intelligent assistant and will follow the instructions given to you to fulfill the goal. The answer should be in the format as in the given example."},
